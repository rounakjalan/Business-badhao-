...
export default function DashboardError({
  ...
  return (
    <div className="bb-animate-fade-in m-6 flex flex-1 flex-col items-center justify-center rounded-xl border border-dashed border-bb-rose/30 bg-bb-rose/5 px-6 py-16 text-center">
