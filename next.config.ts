...
const nextConfig: NextConfig = {
  ...
  // own source files (worker.mjs, lib/*.mjs, package.json) off this deployment's
  // own filesystem at request time, to upload them into the on-demand Vercel
  ...
  outputFileTracingIncludes: {
    "/**": ["./hermes-browser-runtime/worker.mjs", "./hermes-browser-runtime/lib/*.mjs", "./hermes-browser-runtime/package.json", "./hermes-browser-runtime/package-lock.json"],
  },
};
